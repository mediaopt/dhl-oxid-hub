(function ($) {
    ...
    mo_dhl__finder = {
        addFinderButton: function () {
            var self = this;
            var finderButton = $('#moDhlNewAddressButton');
        ...
        addInfoBox: function (provider, marker) {
            ...
            var address;
            if (provider.id === 'regular'){
                address = provider.address
            } else {
                address = marker.title + ", " + provider.address.street + " " + provider.address.streetNo + ", "
