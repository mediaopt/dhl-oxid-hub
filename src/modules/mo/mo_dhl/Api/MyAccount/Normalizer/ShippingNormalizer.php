...
class ShippingNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mediaopt\\DHL\\Api\\MyAccount\\Model\\Shipping';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mediaopt\\DHL\\Api\\MyAccount\\Model\\Shipping';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mediaopt\DHL\Api\MyAccount\Model\Shipping();
        ...
        if (\array_key_exists('details', $data)) {
            ...
            foreach ($data['details'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Mediaopt\\DHL\\Api\\MyAccount\\Model\\Detail', 'json', $context);
            }
    ...
    {
        return array('Mediaopt\\DHL\\Api\\MyAccount\\Model\\Shipping' => false);
    }
}