...
class ResponseItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('returnRoutingCode', $data)) {
            $object->setReturnRoutingCode($data['returnRoutingCode']);
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('returnRoutingCode') && null !== $object->getReturnRoutingCode()) {
            $data['returnRoutingCode'] = $object->getReturnRoutingCode();
        }
