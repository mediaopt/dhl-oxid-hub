...
class GetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mediaopt\\DHL\\Api\\Authentication\\Model\\GetResponse200';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mediaopt\\DHL\\Api\\Authentication\\Model\\GetResponse200';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mediaopt\DHL\Api\Authentication\Model\GetResponse200();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('amp', $data)) {
            $object->setAmp($this->denormalizer->denormalize($data['amp'], 'Mediaopt\\DHL\\Api\\Authentication\\Model\\GetResponse200Amp', 'json', $context));
            unset($data['amp']);
        }
    ...
    {
        return array('Mediaopt\\DHL\\Api\\Authentication\\Model\\GetResponse200' => false);
    }
}