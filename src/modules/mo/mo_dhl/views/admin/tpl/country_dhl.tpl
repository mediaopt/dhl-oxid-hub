                    ...
                    [{if $oxid != "-1"}]
                        <tr>
                            <td class="edittext" width="140">
                                [{oxmultilang ident="MO_DHL__RETOURE_RECEIVER_ID"}]
                            </td>
                            <td class="edittext" width="250">
                                <input name="editval[oxcountry__mo_dhl_retoure_receiver_id]" maxlength="30"
                                       value="[{$edit->oxcountry__mo_dhl_retoure_receiver_id->rawValue}]"
                                       [{$readonly}]
                                />
                                [{oxinputhelp ident="HELP_MO_DHL__RETOURE_RECEIVER_ID"}]
                            </td>
                        </tr>
                        <tr>
                            <td class="edittext">
