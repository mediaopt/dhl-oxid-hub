...
[{oxscript include=$oViewConf->getModuleUrl("mo_dhl", "out/src/js/empfaengerservices.js") priority=9}]
...
[{if $oViewConf->moHasAncestorTheme('azure')}]
    ...
    [{oxscript include=$oViewConf->getModuleUrl("mo_dhl", "out/src/js/widgets/azure/empfaengerservices.js") priority=9}]
    [{oxscript include=$oViewConf->getModuleUrl("mo_dhl", "out/src/js/widgets/azure/empfaengerservices__validation.js") priority=10}]
[{elseif $oViewConf->moHasAncestorTheme('flow')}]
    [{oxscript include=$oViewConf->getModuleUrl("mo_dhl", "out/src/js/widgets/flow/empfaengerservices.js") priority=9}]
[{elseif $oViewConf->moHasAncestorTheme('wave')}]
    [{oxscript include=$oViewConf->getModuleUrl("mo_dhl", "out/src/js/widgets/wave/empfaengerservices.js") priority=9}]
[{/if}]
