<div style="display: none">
    [{if $oViewConf->moIsAnyWunschpaketFeatureActivated()}]
        <div id="moEmpfaengerservicesWunschpaket" class="moEmpfaengerservicesWunschpaketFlow col-lg-offset-3"
             ...
             data-theme="flow" data-timeanddate="[{$oViewConf->getSslSelfLink()}]cl=MoEmpfaengerservicesYellowBox&zip=">
