    ...
    <div class="modal-dialog" id="modalMap" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form id="moEmpfaengerservicesFinderForm" class="col-12">
                    ...
                    [{if $oViewConf->moCanFilialeBeSelected()}]
                        ...
                        [{/if}]
                    [{/if}]
                    <button class="btn btn-outline-dark submitButton">[{oxmultilang ident="MO_EMPFAENGERSERVICES__SEARCH"}]</button>
                    </div>
                </form>
            </div>
