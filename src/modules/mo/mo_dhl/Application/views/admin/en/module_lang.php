...
$aLang = [
    ...
    'MO_DHL__PARTICIPATION_NUMBER'                 => 'Participation number/Product-Id',
    ...
    'MO_DHL__INTERNETMARKE_PRODUCT_ERROR'          => 'The specified produkt for Internetmarke could not be found. Please use an ID from the list in DHL > Internetmarke > Products.',
