...
$aLang = [
    ...
    'HELP_SHOP_MODULE_mo_dhl__account_sandbox'  => 'Nutze den Testing-Webservice von DHL anstatt des Productive-Webservice. In diesem Fall müssen Sie unten die Zugangsdaten zu Ihrem <a href="https://entwickler.dhl.de" target="_blank">DHL-Entwickler-Portal</a>-Account angeben.',
    'SHOP_MODULE_mo_dhl__account_user'          => 'Benutzername',
    'HELP_SHOP_MODULE_mo_dhl__account_user'     => 'Ihr Benutzername für das <a href="https://www.dhl-geschaeftskundenportal.de" target="_blank">DHL Geschäftskundenportal</a>. Hierbei ist die korrekte Groß- und Kleinschreibung zu beachten. Noch kein Kunde? Dann registrieren Sie sich <a href="https://www.dhl.de/de/geschaeftskunden/paket/kunde-werden/angebot-dhl-geschaeftskunden-online.html" target="_blank">hier</a>.',
    'SHOP_MODULE_mo_dhl__account_password'      => 'Passwort',
    'HELP_SHOP_MODULE_mo_dhl__account_password' => 'Ihr Passwort für das <a href="https://www.dhl-geschaeftskundenportal.de" target="_blank">DHL Geschäftskundenportal</a>.',
