...
$aLang = [
    ...
    'MO_DHL__ERROR_PRINT_FORMAT'       => 'Fehler %s wurde geworfen in Zeile %d in der Datei %s',
    'MO_DHL__ERROR_WHILE_EXECUTION'    => 'Bei der Ausführung is folgender Fehler aufgetreten:',
